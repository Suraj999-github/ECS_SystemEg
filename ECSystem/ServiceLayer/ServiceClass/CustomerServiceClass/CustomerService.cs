    ...
    public class CustomerService : ICustomerService
    {
        ...
        {            
            try
            {
                ...
                //sql += "@flag = " + handler.FilterString();
                //sql += ",@UserId = " + dao.FilterString(objData.UserId);
                //sql += ",@password=" + dao.FilterString(objData.Password);
                //sql += ",@UserName = " + dao.FilterString(objData.UserName);
                //sql += ",@FullName = " + dao.FilterString(objData.FullName);
